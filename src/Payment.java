...
public class Payment extends javax.swing.JFrame {
    ...
    public void tableDetails()
    {
        ...
        try
        {
            ...
            ResultSet rs=st.executeQuery("select *from payment where id='"+member_id+"'");
            while(rs.next())
            {
    ...
    private void initComponents() {
        ...
        jButton1.setForeground(new java.awt.Color(0, 188, 221));
        ...
        jTable1.setFont(new java.awt.Font("Algerian", 1, 14)); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ...
            ResultSet rs1=st.executeQuery("select *from payment inner join member where payment.month='"+month+"' and payment.id='"+member_id+"' and member.member_id='"+member_id+"'");
            while(rs1.next())
            {
